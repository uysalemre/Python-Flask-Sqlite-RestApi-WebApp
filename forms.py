...
class ChangeEmailForm(FlaskForm):
    ...
    confirmemail = StringField("EMAIL",
                               validators=[InputRequired("EMAIL IS REQUIRED"), Email("PLEASE GIVE A VALID EMAIL")])
...
class ContactForm(FlaskForm):
    ...
    file = FileField("PDF OR DOCX FILE",
                     validators=[FileAllowed(['docx', 'pdf'], 'SADECE DOCX VEYA PDF DOSYASI GEÇERLİDİR.')])
